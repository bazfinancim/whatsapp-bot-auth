...
async function sendFormReminder(session, stage) {
    try {
        // CONSOLIDATED: Use BASE_URL since chatbot is now served from this app
        const formUrl = `${process.env.BASE_URL || 'https://whatsapp-bot-auth-production.onrender.com'}/chatbot?session=${session.session_id}`;

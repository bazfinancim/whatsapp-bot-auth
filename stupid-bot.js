...
const BOT_CONFIG = {
    ...
    messages: {
        ...
        // Message #2: Chatbot link (immediate)
...
async function handleTriggerMessage(client, chatId, logger, dbPool = null) {
    try {
        ...
        // Message #2: Send chatbot link immediately
        try {
            ...
            logger.info(`🤖 [STUPID-BOT] Sent chatbot link to ${phoneNumber} (immediately after introduction)`);
        } catch (error) {
